...
#Read Dataset
df=pd.read_csv(r"D:\Desktop\DSBDA Final Codes\titanic.csv")
...
fig, axes = plt.subplots(1,2)
fig.suptitle("Histogram of 3-Variables")
sns.histplot(data=df, x="Survived", y="Age", hue="Pclass", multiple="stack",ax=axes[0])
sns.histplot(data=df, x="Age", hue="Pclass", multiple="dodge",ax=axes[1])
plt.show()